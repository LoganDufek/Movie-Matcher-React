    ...
    return (
        <div>
            ...
            <Form
                ...
                <Form.Item label="Find Their Shared Movies!" >

                </Form.Item>
                <Form.Item label="First Actor" name="actorOne">
                    <Input placeholder="eg. Tom Hanks" onChange={handleChange1} />
                </Form.Item>
                <Form.Item label="Second Actor" name="actorTwo">
                    <Input placeholder="eg. Tim Allen" onChange={handleChange2} />
                </Form.Item>
                <Form.Item >
                    <Button type="primary" onClick={searchActors}>Search!</Button>
                </Form.Item>
            </Form>
            <div>
                {img}
